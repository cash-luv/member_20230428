...
<section>
    ...
    <div class="container">
        <form action="/update" method="post" onsubmit="return ValidationName()">
            ...
            <input type="text" name="memberEmail" id="memberEmail" value="${}" > <br>
            ...
            <input type="text" name="memberName" id="memberName" placeholder="회원이름을 입력해주세요" readonly> <br>
            <label for="memberBirth"><b>생년월일</b></label>
            <input type="text" name="memberBirth" id="memberBirth" placeholder="생년월일을 입력해주세요" readonly> <br>
